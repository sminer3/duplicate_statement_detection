...
def feed_forward_nn(emb_shape=300, features_shape=5, layer1=75, n_layer1_hidden=0, dropout_rate1 = .4, layer1_reg =.01, layer2=30, n_layer2_hidden = 0, dropout_rate2 = .3, layer2_reg =.01, features=10, dropout_rate_features = .1, feature_reg = .01, activation='relu'):
